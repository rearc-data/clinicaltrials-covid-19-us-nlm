...
DATASET_NAME='clinicaltrials-covid-19-us-nlm'
DATASET_ARN='arn:aws:dataexchange:us-east-1:796406704065:data-sets/6fcc02d0fff3eda75e8424e326243639'
PRODUCT_NAME='Clinical Studies Related To COVID-19 | ClinicalTrials.gov (US NLM)'
PRODUCT_ID='prod-x6vrwdw4grxim'
SCHEDULE_CRON="cron(0 9,23 * * ? *)"
REGION='us-east-1'
PROFILE='default'
